...
This RMarkdown file explains the steps taken and results of: -Importing the Mushrooms dataset
-Creating a data frame
-Adding column headers
-Replacing certain abbreviations found in the dataset for clarity
...
Columns selected: Edible/Poisonous, Cap-Shape, Cap-Surface, Cap-Color, and Odor.
